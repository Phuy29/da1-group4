                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="slider-content s-slider-content mt-80 text-center">
                            ...
                            <p data-animation="fadeInUp" data-delay=".6s">Donec vitae libero non enim placerat eleifend
                                aliquam erat volutpat. Curabitur diam ex, dapibus purus sapien, cursus sed nisl
                                tristique, commodo gravida lectus non.</p>

                            <div class="slider-btn mt-30 mb-105">
                                <a href="../../contact.html" class="btn ss-btn active mr-15" data-animation="fadeInLeft"
                                   data-delay=".4s">Discover More </a>
                                <a href="https://www.youtube.com/watch?v=gyGsPlt06bo" class="video-i popup-video"
                                   data-animation="fadeInUp" data-delay=".8s" style="animation-delay: 0.8s;"
                                   tabindex="0"><i class="fas fa-play"></i> Intro Video</a>
                            </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="slider-btn">
                                ...
                                <button class="btn ss-btn" data-animation="fadeInRight" data-delay=".8s">Check
                                    Availability
                                </button>
                            </div>
                        </li>
...
<section class="about-area about-p pt-120 pb-120 p-relative fix">
    <div class="animations-02"><img src="public/img/bg/an-img-02.png" alt="contact-bg-an-02"></div>
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="s-about-img p-relative  wow fadeInLeft animated" data-animation="fadeInLeft"
                     data-delay=".4s">
                    <img src="public/img/features/about_img_02.png" alt="img">
                    <div class="about-icon">
                        <img src="public/img/features/about_img_03.png" alt="img">
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="about-content s-about-content  wow fadeInRight  animated pl-30" data-animation="fadeInRight"
                    ...
                    <p>Morbi tortor urna, placerat vel arcu quis, fringilla egestas neque. Morbi sit amet porta erat,
                        quis rutrum risus. Vivamus et gravida nibh, quis posuere felis. In commodo mi lectus, Integer
                        ligula lorem, finibus vitae lorem vitae tincidunt dolor consequat quis.</p>
                    <p>Cras finibus laoreet felis et hendrerit. Integer ligula lorem, finibus vitae lorem at, egestas
                        ...
                        blandit. Aenean eu vulputate lorem, quis auctor lectus.</p>
                    <div class="about-content3 mt-30">
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-md-6 text-right">
                                <div class="signature">
                                    <img src="public/img/features/signature.png" alt="img">
                                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="section-title center-align mb-50 text-center">
                    ...
                    <p>Proin consectetur non dolor vitae pulvinar. Pellentesque sollicitudin dolor eget neque viverra,
                        sed interdum metus interdum. Cras lobortis pulvinar dolor, sit amet ullamcorper dolor iaculis
                        vel</p>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="services-08-item mb-30">
                    <div class="services-icon2">
                        <img src="public/img/icon/fe-icon01.png" alt="img">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="services-08-item mb-30">
                    <div class="services-icon2">
                        <img src="public/img/icon/fe-icon04.png" alt="img">
                    </div>
                    <div class="services-08-thumb">
                        <img src="public/img/icon/fe-icon04.png" alt="img">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="services-08-item mb-30">
                    <div class="services-icon2">
                        <img src="public/img/icon/fe-icon05.png" alt="img">
                    </div>
                    <div class="services-08-thumb">
                        <img src="public/img/icon/fe-icon05.png" alt="img">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="services-08-item mb-30">
                    <div class="services-icon2">
                        <img src="public/img/icon/fe-icon06.png" alt="img">
                    </div>
                    <div class="services-08-thumb">
                        <img src="public/img/icon/fe-icon06.png" alt="img">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="services-08-item mb-30">
                    <div class="services-icon2">
                        <img src="public/img/icon/fe-icon07.png" alt="img">
                    </div>
                    <div class="services-08-thumb">
                        <img src="public/img/icon/fe-icon07.png" alt="img">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="services-08-item mb-30">
                    <div class="services-icon2">
                        <img src="public/img/icon/fe-icon08.png" alt="img">
                    </div>
                    <div class="services-08-thumb">
                        <img src="public/img/icon/fe-icon08.png" alt="img">
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="single-services mb-30">
                    ...
                    <div class="services-content">
                        ...
                        <p>Aenean vehicula ligula eu rhoncus porttitor. Duis vel lacinia quam. Nunc rutrum porta place
                            ullam ipsum. Morbi imperdiet, orci et dapibus.</p>
                        <div class="icon">
                            <ul>
                ...
                <div class="single-services mb-30">
                    <div class="services-thumb">
                        <a class="gallery-link popup-image" href="../../img/gallery/room-img02.png">
                            <img src="public/img/gallery/room-img02.png" alt="img">
                        </a>
                    </div>
                    <div class="services-content">
                        <div class="day-book">
                        ...
                        <p>Aenean vehicula ligula eu rhoncus porttitor. Duis vel lacinia quam. Nunc rutrum porta ex, in
                            imperdiet tortor feugiat at.</p>
                        <div class="icon">
                            <ul>
                                <li><img src="public/img/icon/sve-icon1.png" alt="img"></li>
                                <li><img src="public/img/icon/sve-icon2.png" alt="img"></li>
                ...
                <div class="single-services mb-30">
                    <div class="services-thumb">
                        <a class="gallery-link popup-image" href="../../img/gallery/room-img03.png">
                            <img src="public/img/gallery/room-img03.png" alt="img">
                        </a>
                    </div>
                    <div class="services-content">
                        <div class="day-book">
                ...
                <div class="single-services mb-30">
                    <div class="services-thumb">
                        <a class="gallery-link popup-image" href="../../img/gallery/room-img04.png">
                            <img src="public/img/gallery/room-img04.png" alt="img">
                        </a>
                    </div>
                    <div class="services-content">
                        <div class="day-book">
...
<section class="feature-area2 p-relative fix" style="background: #f7f5f1;">
    <div class="animations-02"><img src="public/img/bg/an-img-02.png" alt="contact-bg-an-05"></div>
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12 pr-30">
                <div class="feature-img">
                    <img src="public/img/features/feature.png" alt="img" class="img">
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="feature-content s-about-content">
                    ...
                    <p>Vestibulum non ornare nunc. Maecenas a metus in est iaculis pretium. Aliquam ullamcorper nibh
                        lacus, ac suscipit ipsum consequat porttitor.Aenean vehicula ligula eu rhoncus porttitor. Duis
                        vel lacinia quam. Nunc rutrum porta ex, in imperdiet tortor feugiat at.</p>
                    <p>Cras finibus laoreet felis et hendrerit. Integer ligula lorem, finibus vitae lorem at, egestas
                        consectetur urna. Integer id ultricies elit. Maecenas sodales nibh, quis posuere felis. In
                        commodo mi lectus venenatis metus eget fringilla. Suspendisse varius ante eget.</p>
...
<section id="pricing" class="pricing-area pt-120 pb-60 fix p-relative">
    <div class="animations-01"><img src="public/img/bg/an-img-01.png" alt="an-img-01"></div>
    <div class="animations-02"><img src="public/img/bg/an-img-02.png" alt="contact-bg-an-01"></div>
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <p>Proin consectetur non dolor vitae pulvinar. Pellentesque sollicitudin dolor eget neque viverra, sed
                    interdum metus interdum. Cras lobortis pulvinar dolor, sit amet ullamcorper dolor iaculis vel</p>
                <p>Cras finibus laoreet felis et hendrerit. Integer ligula lorem, finibus vitae lorem at, egestas
                    consectetur urna. Integer id ultricies elit. Maecenas sodales nibh, quis posuere felis. In commodo
                    mi lectus venenatis metus eget fringilla. Suspendisse varius ante eget.</p>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="pricing-box pricing-box2 mb-60">
                    ...
                    <div class="pricing-btn">
                        <a href="../../contact.html" class="btn ss-btn">Get Started <i
...
<section class="testimonial-area pt-120 pb-90 p-relative fix"
         style="background-image: url(../../img/bg/testimonial-bg.png); background-size: cover;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title center-align mb-50 text-center">
                ...
                <div class="testimonial-active">
                    <div class="single-testimonial">
                        <div class="testi-author">
                            <img src="public/img/testimonial/testi_avatar.png" alt="img">
                            <div class="ta-info">
                                <h6>Jina Nilson</h6>
                                <span>Client</span>
                            </div>
                        ...
                        <p>“Phasellus aliquam quis lorem amet dapibus feugiat vitae purus vitae efficitur. Vestibulum
                            sed elit id orci rhoncus ultricies. Morbi vitae semper consequat ipsum semper quam”.</p>

                        <div class="qt-img">
                            <img src="public/img/testimonial/qt-icon.png" alt="img">
                        </div>
                    </div>
                    <div class="single-testimonial">
                        <div class="testi-author">
                            <img src="public/img/testimonial/testi_avatar_02.png" alt="img">
                            <div class="ta-info">
                    ...
                    <div class="single-testimonial">
                        <div class="testi-author">
                            <img src="public/img/testimonial/testi_avatar_03.png" alt="img">
                            <div class="ta-info">
                                <h6>Roboto Dose</h6>
                                <span>Client</span>
                            </div>
                ...
                <div class="contact-bg02">
                    ...
                    <form action="https://zcube.in/riorelax/mail.php" method="post" class="contact-form mt-30">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="slider-btn mt-15">
                                    <button class="btn ss-btn" data-animation="fadeInRight" data-delay=".8s"><span>Book Table Now</span>
                                    </button>
                                </div>
                            </div>
                        </div>
...
<!-- booking-area-end -->
<!-- video-area -->
<section id="video" class="video-area pt-150 pb-150 p-relative"
         style="background-image:url(public/img/bg/video-bg.png); background-repeat: no-repeat; background-position: center bottom; background-size:cover;">
    <!-- Lines -->
            ...
            <div class="col-12">
                <div class="s-video-wrap">
                    <div class="s-video-content">
                        <a href="https://www.youtube.com/watch?v=gyGsPlt06bo" class="popup-video"><img
                                    src="public/img/bg/play-button.png" alt="circle_right"></a>
...
<section id="blog" class="blog-area p-relative fix pt-90 pb-90">
    <div class="animations-02"><img src="public/img/bg/an-img-06.png" alt="contact-bg-an-05"></div>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp"
                    ...
                    <div class="blog-thumb2">
                        <a href="../../blog-details.html"><img src="public/img/blog/inner_b1.jpg" alt="img"></a>
                    </div>
                    <div class="blog-content2">
                        ...
                        <p>Curabitur sagittis libero tincidunt tempor finibus. Mauris at dignissim ligula, nec tristique
                            orci.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp"
                     data-delay=".4s">
                    <div class="blog-thumb2">
                        <a href="../../blog-details.html"><img src="public/img/blog/inner_b2.jpg" alt="img"></a>
                    </div>
                    <div class="blog-content2">
                        <div class="date-home">
                            24th March 2022
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp"
                     data-delay=".4s">
                    <div class="blog-thumb2">
                        <a href="../../blog-details.html"><img src="public/img/blog/inner_b3.jpg" alt="img"></a>
                    </div>
                    <div class="blog-content2">
                        <div class="date-home">
                            24th March 2022
