    ...
    <div class="row">
        <div class="col-12 py-5">
            <div id="auth-left" class="d-flex flex-column align-items-center p-0">
                <h1 class="auth-title">Xác nhận quên mật khẩu</h1>
                <p class="auth-subtitle mb-5 w-50 text-center">
                    Mã xác nhận gồm 4 chữ số đã được gửi đến email của bạn, vui lòng kiểm tra email (mã có hiệu lực
                    trong 5 phút).
                </p>

                <form action="?ctr=<?= $ctr ?? 'home' ?>&act=confirm_forget" id="form" method="post" class="w-50">
