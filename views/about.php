...
<section id="skill" class="skill-area p-relative fix" style="background:#291d16;">
    <div class="animations-01"><img src="public/img/bg/an-img-05.png" alt="contact-bg-an-05"></div>
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="skills-content s-about-content">
                    ...
                    <p>Vestibulum non ornare nunc. Maecenas a metus in est iaculis pretium. Aliquam ullamcorper nibh
                        lacus, ac suscipit ipsum consequat porttitor.</p>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 pr-30">
                <div class="skills-img wow fadeInRight  animated" data-animation="fadeInRight" data-delay=".4s">
                    <img src="public/img/bg/skills-img.png" alt="img" class="img">
                </div>
            </div>
...
<section class="newslater-area p-relative pt-120 pb-120" style="background-color: #f7f5f1;">
    <div class="animations-01"><img src="public/img/bg/an-img-07.png" alt="contact-bg-an-05"></div>
    <div class="container">
            ...
            <div class="col-xl-9 col-lg-9">
                ...
                <form name="ajax-form" id="contact-form4" action="#" method="post" class="contact-form newslater">
                    <div class="form-group">
                        <input class="form-control" id="email3" name="email" type="email"
