...
require_once '../Google/Provider/Google.php';
require_once '../Google/Provider/GoogleUser.php';
require_once '../Google/Exception/HostedDomainException.php';
...
$clientId = '986032993610-64ch51penjqetslpo29gr0mva35pd7s9.apps.googleusercontent.com';
$clientSecret = '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';

//If this automatic URL doesn't work, set it yourself manually to the URL of this script
//$redirectUri = (isset($_SERVER['HTTPS']) ? 'https://' : 'http://') . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF'];
$redirectUri = 'http://localhost/da1-group4/public/PHPMailer/get_oauth_token.php';
